...
/* Arreglo de registros y variable auxiliar.*/
float r[14];
...
/**
 * Metodo que unifica los bytes de una palabra para determinar su valor en registro.
 * @param b Apuntador al primer byte de la palabra.
 * @return Devuelve el valor en registro de la palabra.
 */
float btor(char *b){return (b[0] << 24) | (b[1] << 16) | (b[2] << 8) | (b[3]);}

/**
* Funcion que guarda el volcado de memoria en un archivo binario.
*/
void guardaVolcado() {
